...
#define S5P_ASS_CLK_PABASE  0xC0900000  /* ASS Clock CON Register Base */
#define S5P_ASS_COM_PABASE  0xC0A00000  /* ASS COMMBOX Register Base */
#define S5P_ASS_SRBUF_BASE  0xC0000000  /* ASS SRAM Buffer Base */

/* Offset of CLKCON Register */
#define S5P_ASS_CLKCON				(0x00)
#define S5P_ASS_CLKDIV				(0x04)
#define S5P_ASS_CLKGATE				(0x08)

/* Offset of COMMBOX Register */
...
#define S5P_ASS_CLKCON_XXTI			(0x0<<0)
#define S5P_ASS_RP_BOOT_IN			(0x1<<0)
#define S5P_ASS_CLK_I2S_MASK			(0x0<<6)
