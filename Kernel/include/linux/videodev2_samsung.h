...
/* Giridhar (17Jun2010): Making use of V4L2_CID_SCALE_PICTURE
 * to scape picture in memory using FIMC0
 */
#define V4L2_CID_SCALE_PICTURE (V4L2_CID_PRIVATE_BASE + 12)
...
/* Giridhar (17Jun2010): We are making use of this structure to scale pictures in memory
 */
struct scalerInfo {
        __u32 srcAddr;          //physical address of the source picture
        __u32 srcFmt;           //colour format of the sourrce picture
        __u32 srcWidth;         //width of the source picture
        __u32 srcHeight;        //height of the source picture

	__u32 dstAddr;          //physical address of the destination picture
        __u32 dstFmt;           //colour format of the destination picture
        __u32 dstWidth;         //width of the destination picture
        __u32 dstHeight;        //height of the destination picture
};
