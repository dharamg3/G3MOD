...
u32 s5p_cpu_clk_tab_ov[][10] = {
        { 950*MHZ, 185*MHZ, (185*MHZ)/2, 185*MHZ,   4, 0, 0, 1, 0, 1},
        { 760*MHZ, 185*MHZ, (185*MHZ)/2, 185*MHZ,   3, 0, 0, 1, 0, 1},
        { 570*MHZ, 185*MHZ, (185*MHZ)/2, 185*MHZ,   3, 0, 0, 1, 0, 1},
        { 380*MHZ, 185*MHZ, (185*MHZ)/2, 185*MHZ,   3, 0, 0, 1, 0, 1},
	{ 190*MHZ, 185*MHZ, (185*MHZ)/2, 185*MHZ,   3, 0, 0, 1, 0, 1},
};

u32 s5p_cpu_pll_tab[][4] = {
// A P L L                                 M P L L
{((1 << 31) | (475 << 16) | (3 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (760 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (570 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (380 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (190 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
};
