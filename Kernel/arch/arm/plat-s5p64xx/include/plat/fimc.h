/* linux/arch/arm/plat-s5p64xx/include/plat/fimc.h
 *
...
//giridhar: adding preview and camera resolutions
	int				width_preview;		/* default resol */
	int				height_preview;		/* default resol */
	struct v4l2_rect		window_preview;		/* real cut region from source */

	int				width_capture;		/* default resol */
	int				height_capture;		/* default resol */
	struct v4l2_rect		window_capture;		/* real cut region from source */
