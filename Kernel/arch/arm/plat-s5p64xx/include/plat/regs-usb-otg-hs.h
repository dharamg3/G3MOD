...
#define S3C_UDC_OTG_EP_FIFO(n)		S3C_USBOTGREG(0x1000 + n*0x1000)
...
//6410 #define STOP_PCLK_BIT		(0)
//6410 #define GATE_HCLK_BIT		(1)
...
#define MAX_RX_FIFO_SIZE		(7936)
#define MAX_NPTX_FIFO_SIZE		(7936)
#define MAX_PTX_FIFO_SIZE		(768)
