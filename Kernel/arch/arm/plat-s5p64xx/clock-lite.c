...
u32 s5p_cpu_clk_tab_ov[][10] = {
        { 667*MHZ, 166*MHZ, (166*MHZ)/2, 166*MHZ,   3, 0, 0, 1, 0, 1},
        { 333*MHZ, 166*MHZ, (166*MHZ)/2, 166*MHZ,   3, 0, 0, 1, 0, 1},
        { 222*MHZ, 166*MHZ, (166*MHZ)/2, 166*MHZ,   3, 0, 0, 1, 0, 1},
        { 166*MHZ, 166*MHZ, (16*MHZ)/2, 166*MHZ,   3, 0, 0, 1, 0, 1},
	{ 83*MHZ, 166*MHZ, (166*MHZ)/2, 166*MHZ,   3, 0, 0, 1, 0, 1},
};

u32 s5p_cpu_pll_tab[][4] = {
// A P L L                                 M P L L
{((1 << 31) | (667 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (333 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (222 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (166 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (83 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
};
