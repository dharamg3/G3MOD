...
#define S5P64XX_SROM_BW_DATA_WIDTH5_8BIT	(0 << 20)
#define S5P64XX_SROM_BW_DATA_WIDTH5_16BIT	(1 << 20)
#define S5P64XX_SROM_BW_DATA_WIDTH5_MASK	(1 << 20)

#define S5P64XX_SROM_BW_WAIT_ENABLE5_DISABLE	(0 << 22)
#define S5P64XX_SROM_BW_WAIT_ENABLE5_ENABLE	(1 << 22)
#define S5P64XX_SROM_BW_WAIT_ENABLE5_MASK	(1 << 22)

#define S5P64XX_SROM_BW_BYTE_ENABLE5_DISABLE	(0 << 23)
#define S5P64XX_SROM_BW_BYTE_ENABLE5_ENABLE	(1 << 23)
#define S5P64XX_SROM_BW_BYTE_ENABLE5_MASK	(1 << 23)
