...
extern int s3c_gpio_pdn_cfgpin(unsigned int pin, unsigned int to);
extern s3c_gpio_pull_t s3c_gpio_get_pdn_cfgpin(unsigned int pin);
...
extern int s3c_gpio_set_drv_str(unsigned int pin, unsigned int config);

extern int s3c_gpio_set_pdn_pud(unsigned int pin, unsigned int config);
extern s3c_gpio_pull_t s3c_gpio_get_pdn_pud(unsigned int pin);
