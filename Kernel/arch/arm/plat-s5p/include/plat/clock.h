...
extern int s5p64xx_clk_main0_ctrl(struct clk *clk, int enable);
extern int s5p64xx_clk_main1_ctrl(struct clk *clk, int enable);
extern int s5p64xx_clk_main2_ctrl(struct clk *clk, int enable);
extern int s5p64xx_clk_peri0_ctrl(struct clk *clk, int enable);
extern int s5p64xx_clk_peri1_ctrl(struct clk *clk, int enable);
