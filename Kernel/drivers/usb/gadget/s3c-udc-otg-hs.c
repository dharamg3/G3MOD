...
static void S3c_udc_early_suspend(struct early_suspend *);
static void S3c_udc_late_resume(struct early_suspend *);
//---------------------------------------------------------------------------------------
...
//	local_irq_enable();
	...
	dev->early_suspend.suspend = S3c_udc_early_suspend;
	dev->early_suspend.resume = S3c_udc_late_resume;
