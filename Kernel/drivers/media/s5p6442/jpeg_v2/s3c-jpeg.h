...
#define IOCTL_JPG_SET_STRBUF			0x0000000E
#define IOCTL_JPG_SET_FRMBUF			0x0000000F
#define IOCTL_JPG_SET_THUMB_STRBUF		0x00000012
#define IOCTL_JPG_SET_THUMB_FRMBUF		0x00000013
